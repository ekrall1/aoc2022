...
module UnitTests =
    ...
    let ``Day 20 Part 2`` () =
        let input = readTestInput "Day20.txt"
        let result = Dispatch.wrap 20 |> fun runner -> runner.part2 input
        Assert.Equal("1623178306", result)

    let ``Day 21 Part 1`` () =
        let input = readTestInput "Day21.txt"
        let result = Dispatch.wrap 21 |> fun runner -> runner.part1 input
        Assert.Equal("152", result)

    let ``Day 21 Part 2`` () =
        let input = readTestInput "Day21.txt"
        let result = Dispatch.wrap 21 |> fun runner -> runner.part2 input
        Assert.Equal("301", result)

    [<Fact>]
    let ``Day 22 Part 1`` () =
        let input = readTestInput "Day22.txt"
        let result = Dispatch.wrap 22 |> fun runner -> runner.part1 input
        Assert.Equal("6032", result)

    [<Fact>]
    let ``Day 22 Part 2`` () =
        let input = readTestInput "Day22.txt"
        let result = Dispatch.wrap 22 |> fun runner -> runner.part2 input
        Assert.Equal("5031", result)

    [<Fact>]
    let ``Day 23 Part 1`` () =
        let input = readTestInput "Day23.txt"
        let result = Dispatch.wrap 23 |> fun runner -> runner.part1 input
        Assert.Equal("110", result)

    [<Fact>]
    let ``Day 23 Part 2`` () =
        let input = readTestInput "Day23.txt"
        let result = Dispatch.wrap 23 |> fun runner -> runner.part2 input
        Assert.Equal("20", result)

    [<Fact>]
    let ``Day 24 Part 1`` () =
        let input = readTestInput "Day24.txt"
        let result = Dispatch.wrap 24 |> fun runner -> runner.part1 input
        Assert.Equal("18", result)

    [<Fact>]
    let ``Day 24 Part 2`` () =
        let input = readTestInput "Day24.txt"
        let result = Dispatch.wrap 24 |> fun runner -> runner.part2 input
